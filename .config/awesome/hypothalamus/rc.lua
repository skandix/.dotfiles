...
lowervol      = "amixer -q set Master 5%-"
highervol     = "amixer -q set Master 5%+"

-- Backligth Control

incligth      = "xbacklight -inc 15"
decligth      = "xbacklight -dec 15"
...
if beautiful.wallpaper then
    for s = 1, screen.count() do
        gears.wallpaper.tiled(beautiful.wallpaper, s)
         Rgears.wallpaper.maximized(beautiful.wallpaper, s, true)
    end
end
...
mytextclock    = awful.widget.textclock(markup(clockgf, space3 .. "%H:%M:%S" .. markup.font("Tamsyn 3", " ")))
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "g", function () exec(wireless) end),
    awful.key({ modkey,           }, "s", function () exec(spotify) end),
    awful.key({ modkey,           }, "q", function () exec(chromium) end),
    awful.key({ modkey,           }, "d", function () exec(sublime) end),
    awful.key({ modkey,           }, "v", function () exec(vlc) end),   

    -- Volume keys 
    awful.key({ }, "XF86AudioRaiseVolume", function () exec(highervol) end),
    awful.key({ }, "XF86AudioLowerVolume", function () exec(lowervol) end),
    awful.key({ }, "XF86AudioMute", function () exec(mute) end),

    -- Backligth Control
    awful.key({ }, "XF86MonBrightnessUp", function () exec(incligth) end),
    awful.key({ }, "XF86MonBrightnessDown", function () exec(decligth) end),

-- user defined hotkeys
    --awful.key({ modkey, "q" }, function () exec(spotify) end),
    --awful.key({ modkey, "s" }, function () exec(rootterm) end),
